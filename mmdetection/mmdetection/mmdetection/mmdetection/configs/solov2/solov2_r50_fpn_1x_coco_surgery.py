...
#         num_datasets=6),
#     dataset=dict(
#         type='ConcatDataset', datasets=[dataset_511B, dataset_511B, dataset_511B, dataset_511B, dataset_511B, dataset_511B])) #, dataset_5171C, dataset_5172D,dataset_5172F]))
...
model = dict(
    ...
    backbone=dict(
        ...
        out_indices=(0, 1, 2, 3),
        frozen_stages=1,
        init_cfg=dict(type='Pretrained', checkpoint='torchvisions://resnet50'),
        style='pytorch'),
    neck=dict(
        type='FPN',
...
default_hooks = dict(
    ...
    logger=dict(type='LoggerHook', interval=3,out_suffix='json'),
